...
async function run() {
  ...
  try {
    ...
    console.log('Immediate absent test:', r1 && (r1 as any).success ? 'PASS' : 'FAIL', JSON.stringify((r1 as any).telemetry || {}, null, 2))
    ...
    console.log('Boundary stability test:', r2 && (r2 as any).success ? 'PASS' : 'FAIL', JSON.stringify((r2 as any).telemetry || {}, null, 2))
    ...
    console.log('Long flicker timeout test:', !(r3 && (r3 as any).success) ? 'PASS' : 'FAIL', JSON.stringify((r3 as any).telemetry || {}, null, 2))
    ...
    console.log('Short stability test:', r4 && (r4 as any).success ? 'PASS' : 'FAIL', JSON.stringify((r4 as any).telemetry || {}, null, 2))
